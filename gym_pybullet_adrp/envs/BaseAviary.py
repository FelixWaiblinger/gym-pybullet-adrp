...
from gym_pybullet_adrp.utils.enums import DroneModel, Physics, ImageType
...
class BaseAviary(gym.Env):
    ...
    def _housekeeping(self):
        ...
        self.DRONE_IDS = np.array([p.loadURDF(pkg_resources.resource_filename('gym_pybullet_adrp', 'assets/'+self.URDF),
                                              self.INIT_XYZS[i,:],
    ...
    def _parseURDFParameters(self):
        ...
        """
        URDF_TREE = etxml.parse(pkg_resources.resource_filename('gym_pybullet_adrp', 'assets/'+self.URDF)).getroot()
