...
class HardCodedControllerTwoGates(BaseController):
...
###############################################################################
    ...
    def __init__(
        ...
        waypoints.append([gates[0][0] , gates[0][1] + 0.3 , z_low])
        waypoints.append([gates[1][0], gates[1][1] , z_high + 0.1])
        waypoints = np.array(waypoints)

        tck, _ = interpolate.splprep([waypoints[:, 0], waypoints[:, 1], waypoints[:, 2]], s=0.1, k=2)
